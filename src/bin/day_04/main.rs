...
mod tests {
    ...
    fn test_part_one_test() {
        let result = part_one("src/bin/day_04/day04_test.txt");
        assert_eq!(result, 18);
    }

    #[test]
    fn test_part_one_data() {
        let result = part_one("src/bin/day_04/day04_data.txt");
        assert_eq!(result, 2599);
    }

    #[test]
    fn test_part_two_test() {
        let result = part_two("src/bin/day_04/day04_test.txt");
        assert_eq!(result, 9);
    }

    #[test]
    fn test_part_two_data() {
        let result = part_two("src/bin/day_04/day04_data.txt");
