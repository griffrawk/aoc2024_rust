...
mod tests {
    ...
    fn test_part_one_test() {
        let result = part_one("src/bin/day_03/day03_test.txt");
        assert_eq!(result, 161);
    }

    #[test]
    fn test_part_one_data() {
        let result = part_one("src/bin/day_03/day03_data.txt");
        assert_eq!(result, 161289189);
    }

    #[test]
    fn test_part_two_test() {
        let result = part_two("src/bin/day_03/day03_test.txt");
        assert_eq!(result, 48);
    }

    #[test]
    fn test_part_two_data() {
        let result = part_two("src/bin/day_03/day03_data.txt");
