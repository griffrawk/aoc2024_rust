...
#[cfg(test)]
mod tests {
    use crate::day04::day04::{part_one, part_two, rotate};
    ...
    fn test_part_one_test() {
        let result = part_one("src/day04/day04_test.txt");
        // assert_eq!(result, 18);
    }

    #[test]
    fn test_part_one_data() {
        let result = part_one("src/day04/day04_data.txt");
        assert_eq!(result, 161289189);
    }

    #[test]
    fn test_part_two_test() {
        let result = part_two("src/day04/day04_test.txt");
        assert_eq!(result, 48);
    }

    #[test]
    fn test_part_two_data() {
        let result = part_two("src/day04/day04_data.txt");
