...
mod tests {
    ...
    fn test_part_one_test() {
        let result = part_one("src/bin/day_06/day06_test.txt");
        assert_eq!(result, 41);
    }

    #[test]
    fn test_part_one_data() {
        let result = part_one("src/bin/day_06/day06_data.txt");
        assert_eq!(result, 5095);
    }

    #[test]
    fn test_part_two_test() {
        let result = part_two("src/bin/day_06/day06_test.txt");
        assert_eq!(result, 6);
    }

    #[test]
    fn test_part_two_test_parallel() {
        let result = part_two_parallel("src/bin/day_06/day06_test.txt");
        assert_eq!(result, 6);
    }

    #[test]
    fn test_part_two_data() {
        let result = part_two("src/bin/day_06/day06_data.txt");
        assert_eq!(result, 1933);
    }

    #[test]
    fn test_part_two_data_parallel() {
        let result = part_two_parallel("src/bin/day_06/day06_data.txt");
        assert_eq!(result, 1933);
    }
}
