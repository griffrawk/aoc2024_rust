...
mod tests {
    ...
    fn test_part_one_test() {
        let result = part_one("src/bin/day_01/day01_test.txt");
        assert_eq!(result, 11);
    }

    #[test]
    fn test_part_one_data() {
        let result = part_one("src/bin/day_01/day01_data.txt");
        assert_eq!(result, 1651298);
    }

    #[test]
    fn test_part_two_test() {
        let result = part_two("src/bin/day_01/day01_test.txt");
        assert_eq!(result, 31);
    }

    #[test]
    fn test_part_two_data() {
        let result = part_two("src/bin/day_01/day01_data.txt");
