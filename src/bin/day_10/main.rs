...
mod tests {
    ...
    fn test_part_one_test() {
        let result = part_one("src/bin/day_10/day10_test.txt");
        assert_eq!(result, 36);
    }

    #[test]
    fn test_part_one_data() {
        let result = part_one("src/bin/day_10/day10_data.txt");
        assert_eq!(result, 430);
    }

    #[test]
    fn test_part_two_test() {
        let result = part_two("src/bin/day_10/day10_test.txt");
        assert_eq!(result, 81);
    }

    #[test]
    fn test_part_two_data() {
        let result = part_two("src/bin/day_10/day10_data.txt");
