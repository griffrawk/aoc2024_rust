...
mod tests {
    ...
    fn robot_pos(robot: Robot, max_x: i32, max_y: i32, t: i32) -> Point<i32> {
        ...
        Point {
            x: (robot.pos.x + (robot.dx * t)).rem_euclid(max_x),
    ...
    fn test_part_one_test() {
        let result = part_one("src/bin/day_14/day14_test.txt", 11, 7);
        assert_eq!(result, 12);
    }

    #[test]
    fn test_part_one_data() {
        let result = part_one("src/bin/day_14/day14_data.txt", 101, 103);
        assert_eq!(result, 231852216);
    }

    #[test]
    fn test_part_two_data() {
        let result = part_two("src/bin/day_14/day14_data.txt", 101, 103);
